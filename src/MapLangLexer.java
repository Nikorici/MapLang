...
public class MapLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"MAP", "SIZE", "TILE", "FILL", "ROW", "FROM", "TO", "PLAYER", "AT", "REPEAT", 
			"RANDOM", "COUNT", "IN", "LET", "PART", "PLACE", "IMPORT", "NEIGHBOR", 
			"NORTH", "SOUTH", "EAST", "WEST", "PORTAL", "BACK", "ASSIGN", "PLUS", 
			"MINUS", "STAR", "SLASH", "MOD", "LBRACE", "RBRACE", "LPAREN", "RPAREN", 
			"LBRACKET", "RBRACKET", "COMMA", "SEMI", "ARROW", "ID", "NUMBER", "STRING", 
			"COMMENT", "WS"
		};
	}
